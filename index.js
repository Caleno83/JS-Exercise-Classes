...
class ProjectManager extends Instructor {
  constructor (projectManagerAttrits){
    super(projectManagerAttrits);
    this.gradClassName = projectManagerAttrits.gradClassName;
    this.favInstructor = projectManagerAttrits.favInstructor;
  }
  standUp(channel) {
